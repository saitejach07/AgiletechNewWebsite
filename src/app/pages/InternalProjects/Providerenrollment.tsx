  ...
  return (
    <div className="min-h-screen bg-[#0F172A] text-gray-300">
      ...
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        <Link to="/services/in-house-projects/dashboard" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-cyan-400 to-indigo-500 text-[#0F172A] font-semibold hover:opacity-90 transition" > <ArrowLeft className="w-4 h-4" /> Back to Dashboard </Link> 
