        ...
        <form onSubmit={onSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              onChange={onChange}
              required
              className="w-full rounded-lg bg-[#020617] text-gray-200 border border-white/10 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-400"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 rounded-lg bg-gradient-to-r from-cyan-400 to-indigo-500 text-[#0F172A] font-semibold"
          >
